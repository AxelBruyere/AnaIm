...
%%Parametres
nbr_images = 2; %Nombre d'images a  traiter
dir = 'RubberWhale'; %Choix des images a  traiter
method = 'LK'; %Choix de l'algorithme ('HS' pour Horn et Schunk, 
               %                       'LK' pour Lucas et Kanade)
